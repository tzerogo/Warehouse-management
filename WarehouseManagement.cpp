...
loop:
	...
	drawtext("2.出库", &R2, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("3.查询", &R3, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("4.统记", &R4, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("5.退出", &R5, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	setlinecolor(BLACK);
...
int Queryforward() {
	...
	drawtext("请选择功能序号", &RTZ, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("1.元器件编号", &R1, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("2.元器件名称", &R2, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
...
void Statistics() {
	...
	drawtext("请选择功能序号", &RTZ, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("1.库存总数", &R1, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("2.库存状态", &R2, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("3.在库总价值", &R3, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("4.月出库价值", &R4, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	drawtext("5.月原件消耗", &R5, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	setlinecolor(BLACK);
	rectangle(r[0][0], r[0][1], r[0][2], r[0][3]);
	rectangle(r[1][0], r[1][1], r[1][2], r[1][3]);
	rectangle(r[2][0], r[2][1], r[2][2], r[2][3]);
